//! No-LLM state reducer for Anvil's native ASCII organism.
//!
...
pub(crate) enum Behavior {
    ...
    /// stays beside that finished work instead of anviltting it at settle.
    GuardRecovery,
    ...
    pub(crate) fn command_finished(
        ...
        match kind {
            CommandKind::BuildOrTest => {
                ...
                // A later clean build must not anvilt an earlier recovery that
